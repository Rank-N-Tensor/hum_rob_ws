...
: ${AMENT_CURRENT_PREFIX:="/home/adi/hum_rob_ws/src/install/six_dof"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_dof/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/six_dof/environment/path.sh"
